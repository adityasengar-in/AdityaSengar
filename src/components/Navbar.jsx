  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      <div
        ...
        className="flex items-center gap-1 rounded-full px-2 py-1.5 bg-white/40 backdrop-blur-xl border border-white/50 shadow-lg"
      >
        {/* Home */}
        <div className="relative group flex flex-col items-center">
          <span className="absolute bottom-[calc(100%+25px)] left-1/2 -translate-x-1/2 text-[11px] px-2 py-0.5 rounded-md whitespace-nowrap pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-100 bg-white text-[#333] border border-[#ddd]">
            Home
          </span>
          <a
            href="/"
            ...
            aria-label="Home"
            style={{ width: BASE, height: BASE, transformOrigin: "bottom center" }}
            className="flex items-center justify-center rounded-[10px] text-[#111]"
          >
        ...
        <div className="w-px self-stretch my-1 rounded-full bg-black/15" />
        ...
        <div className="relative group flex flex-col items-center">
          ...
          <a
            ...
            aria-label="Linktree"
            style={{ width: BASE, height: BASE, transformOrigin: "bottom center" }}
            className="flex items-center justify-center rounded-[10px] text-[#555] hover:text-[#111]"
          >
        ...
        {/* Theme toggle — icon swaps on click, no dark mode color logic here, wire that up yourself */}
        <button
          type="button"
